...
public interface VoteViewConsumerCtrl {
    /**
     ...
     */
    VoteViewChangeConsumer createChangeConsumer()
     ...
     * @throws ExecutionException
     */
    VoteViewStreamConsumer createStreamConsumer()
            throws InterruptedException, ExecutionException;
     ...
     */
    void removeConsumer(final VoteViewConsumer voteViewConsumer);
}
